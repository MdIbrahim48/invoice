            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h4 class="card-title text-center" style="color: #ffffff">All Deleted Product</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="submit" href="{{ route('admin.product.restore-product',$product->id) }}" class="btn btn-sm btn-success waves-effect waves-light">
                                        <i class="fas fa-trash-restore d-block p-1 font-size-16"></i>
                                    </a>
                                    <a href="{{ route('admin.product.parmanentDelete',$product->id) }} " id="delete" class="btn btn-sm btn-danger waves-effect waves-light">
