...
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('admin.category.index') }}" key="t-products"><i class="fas fa-users"></i> Expense Category</a></li>
                                    <li><a href="{{ route('admin.expense.index') }}" data-key="t-product-detail"><i class="fas fa-users"></i> All Expense</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('admin.product.index') }}" key="t-products"><i class="fas fa-users"></i> All Product</a></li>
                                    <li><a href="{{ route('admin.product.create') }}" data-key="t-product-detail"><i class="fas fa-users"></i> Create Product</a></li>
                                    <li><a href="{{ route('admin.product.deleted-product') }}" data-key="t-product-detail"><i class="fas fa-users"></i> Deleted Product</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="shopping-cart"></i>
                                    <span data-key="t-ecommerce">Clients</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('admin.client.create') }}" key="t-products"><i class="fas fa-users"></i> Add Client</a></li>
                                    <li><a href="{{ route('admin.client.index') }}" data-key="t-product-detail"><i class="fas fa-users"></i> All Client</a></li>
                                    <li><a href="{{ route('admin.client.deleted-client') }}" data-key="t-product-detail"><i class="fas fa-users"></i> Deleted Client</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="javascript: void(0);" class="has-arrow" key="t-products"> Source</a>
                                        <ul class="sub-menu" aria-expanded="false">
                                            <li><a href="{{ route('admin.invoice.create.source') }}" key="t-products"><i class="fas fa-users"></i> Add Invoice</a></li>
                                            <li><a href="#" data-key="t-product-detail"><i class="fas fa-users"></i> All Invoice</a></li>
                                        </ul>
                                    </li>

                                    <li><a href="javascript: void(0);" class="has-arrow" key="t-products"> Source and Shipment</a>
                                        <ul class="sub-menu" aria-expanded="false">
                                            <li><a href="#" key="t-products"><i class="fas fa-users"></i> Add Invoice</a></li>
                                            <li><a href="#" data-key="t-product-detail"><i class="fas fa-users"></i> All Invoice</a></li>
                                        </ul>
                                    </li>

                                    <li><a href="javascript: void(0);" class="has-arrow" key="t-products"> Shipment</a>
                                        <ul class="sub-menu" aria-expanded="false">
                                            {{-- <li><a href="{{ route('admin.invoice.create.shipment') }}" key="t-products"><i class="fas fa-users"></i> Add Invoice</a></li> --}}
                                            <li><a href="#" data-key="t-product-detail"><i class="fas fa-users"></i> All Invoice</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li>
                                <a href="{{ route('admin.setting.index') }}">
                                    ...
                                    <span data-key="t-chat">Setting</span>
                                </a>
                            </li>
        ...
        <!-- Sweet alert init js-->
        {{-- <script src="{{asset('admin_assets')}}/js/pages/sweetalert.init.js"></script> --}}
    ...
    <link href="{{ asset('admin_assets') }}/libs/choices.js/public/assets/styles/choices.min.css" rel="stylesheet" type="text/css" />
          <!-- color picker js -->
          {{-- <script src="{{ asset('admin_assets') }}/libs/%40simonwep/pickr/pickr.min.js"></script>
