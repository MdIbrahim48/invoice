                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{asset('photo/client')}}/{{ Auth::user()->clientProfile->image }}"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::user()->clientProfile->name }}</span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="{{ route('client.profile.index') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    ...
                                    <span data-key="t-ecommerce">My Source Parcel</span>
                                </a>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="shopping-cart"></i>
                                    <span data-key="t-ecommerce">My Source and Shipment</span>
                                </a>
                                {{-- <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="shopping-cart"></i>
                                    <span data-key="t-ecommerce">My Shipment Parcel</span>
                                </a>
                                {{-- <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <span data-key="t-chat">All Running Parcel</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="fas fa-users"></i>
                                    <span data-key="t-chat">All Delivered Parcel</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="fas fa-users"></i>
                                    <span data-key="t-chat">My Refund</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="fas fa-users"></i>
                                    <span data-key="t-chat">Track Order</span>
                                </a>
                            </li>
